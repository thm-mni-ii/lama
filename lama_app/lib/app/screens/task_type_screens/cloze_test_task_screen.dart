        ...
        BlocBuilder<TTSBloc, TTSState>(
          builder: (context, state) {
            if (state is EmptyTTSState) {
              ...
              context
                  .read<TTSBloc>()
                  .add(QuestionOnInitEvent(task.question!, qlang));
            }
            return Container(
              ...
              child: InkWell(
                onTap: () {
                  BlocProvider.of<TTSBloc>(context).add(
                      ClickOnQuestionEvent.initVoice(task.question!, qlang));
                },
                child: Align(
                  ...
                  children: [
                      ...
                      child: InkWell(
                        onDoubleTap: () => {
                          BlocProvider.of<TTSBloc>(context)
                              .add(ClickOnAnswerEvent(answers[0], alang))
                        },
                        onTap: () {
                          BlocProvider.of<TaskBloc>(context)
                    ...
                    Container(
                      ...
                      child: InkWell(
                        onDoubleTap: () => {
                          BlocProvider.of<TTSBloc>(context)
                              .add(ClickOnAnswerEvent(answers[1], alang))
                        },
                        onTap: () {
                          BlocProvider.of<TaskBloc>(context)
                    ...
                    BlocProvider(
                      ...
                      child: Container(
                        ...
                        child: InkWell(
                          onDoubleTap: () => {
                            BlocProvider.of<TTSBloc>(context)
                                .add(ClickOnAnswerEvent(answers[2], alang))
                          },
                          onTap: () {
                            BlocProvider.of<TaskBloc>(context)
