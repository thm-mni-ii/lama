...
/// [StatelessWidget] that contains the screen for the Picture4Cards TaskType,
/// using 4Cards Skeleton.
///
/// Author: K.Binder
class Picture4CardsScreen extends StatelessWidget {
  final Picture4Cards task;
