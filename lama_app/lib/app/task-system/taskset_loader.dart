        ...
        if (result.isNotEmpty && result[0].rawAddress.isNotEmpty) {
          ...
          for (int i = 1; i <= GRADES_SUPPORTED; i++) {
            ...
            List<TaskUrl> standardTaskUrls = [
              TaskUrl(
                  url:
                      "https://raw.githubusercontent.com/thm-mni-ii/lama/tts/lama_app/assets/standardTasksets/mathe/mathe$i.json"),
              TaskUrl(
                  url:
                      "https://raw.githubusercontent.com/thm-mni-ii/lama/tts/lama_app/assets/standardTasksets/deutsch/deutsch$i.json"),
              TaskUrl(
                  url:
                      "https://raw.githubusercontent.com/thm-mni-ii/lama/tts/lama_app/assets/standardTasksets/englisch/englisch$i.json"),
              TaskUrl(
                  url:
                      "https://raw.githubusercontent.com/thm-mni-ii/lama/tts/lama_app/assets/standardTasksets/sachkunde/sachkunde$i.json"),
            ];
