...
class TasksetLoader {
  ...
  void loadAllTasksets() async {
    ...
    f.writeAsString(
        '{"taskset_name":"Test", "taskset_subject":"Mathe", "taskset_grade":3, "tasks": [{"task_type":"4Cards", "task_reward":2, "question":"4 + 3", "lama_text":"Tippe die richtige Antwort an!","right_answer":"This the answer", "wrong_answers":["4", "3", "1"]}]}');
    f2.writeAsString(
